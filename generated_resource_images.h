...
#define kImgLockIcon [UIImage imageNamed:@"lock_icon"]
#define kImgNoPeoplIcon [UIImage imageNamed:@"no_people_icon"]
#define kImgNoSegmentsIcon [UIImage imageNamed:@"no_segments_icon"]
