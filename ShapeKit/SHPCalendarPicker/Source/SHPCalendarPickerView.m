...
@protocol SHPCalendarPickerCalendarViewDelegate <NSObject>
...
- (UIColor *)calendarPickerCalendarView:(SHPCalendarPickerCalendarView *)calendarPickerView statusColorForDate:(NSDate *)date;

- (void)calendarPickerCalendarView:(SHPCalendarPickerCalendarView *)calendarPickerCalendarView didHighlightDate:(NSDate *)date forCell:(UICollectionViewCell *)cell;
@end
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(calendarPickerCalendarView:statusColorForDate:)]) {
        statusColor = [self.delegate calendarPickerCalendarView:self statusColorForDate:cellDate];
    }
    cell.statusColor = statusColor;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.delegate calendarPickerCalendarView:self didHighlightDate:cellDate forCell:cell];
}
...
- (void)calendarPickerCalendarView:(SHPCalendarPickerCalendarView *)calendarPickerCalendarView didSelectDate:(NSDate *)date {
    ...
    if (currentMonthComponents.month!=cellDateComponents.month) {
...
- (UIColor *)calendarPickerCalendarView:(SHPCalendarPickerCalendarView *)calendarPickerView statusColorForDate:(NSDate *)date {
    if ([self.delegate respondsToSelector:@selector(calendarPickerView:statusColorForDate:)]) {
        return [self.delegate calendarPickerView:self statusColorForDate:date];
    }
    return nil;
}

- (void)calendarPickerCalendarView:(SHPCalendarPickerCalendarView *)calendarPickerCalendarView didHighlightDate:(NSDate *)date forCell:(UICollectionViewCell *)cell {
    if ([self.delegate respondsToSelector:@selector(calendarPickerView:didHighlightDate:forCell:inView:)]) {
        [self.delegate calendarPickerView:self didHighlightDate:date forCell:cell inView:self.currentCalendarView];
    }
}
