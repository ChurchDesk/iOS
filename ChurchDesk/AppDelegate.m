...
- (void) presentLoginViewControllerWhenNeeded {
    ...
    if (authenticationManager.userID == nil || [authenticationManager.userID isEqualToString:@"CHDDeviceToken"]){
        animated = NO;
    }
    else{
        animated = YES;
    }
    // user is logged in initially. Next presentation is animated
